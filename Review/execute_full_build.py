# -*- coding: utf-8 -*-
"""
Execute Full Master Build:
- Generates the 37-slide PowerPoint presentation with Section Dividers and #xx badges.
- Configures slide notes for all 37 slides.
- Saves to KLTN_InterV_LeMinhDuy_v20.pptx and KLTN_InterV_LeMinhDuy_v18.pptx.
- Regenerates analysis markdown and Word speaking script.
"""
...
def run_build():
    ...
    # 2. Add top-left #xx badge to every content slide
    for sec in sections_def:
        tag_text = sec["tag"]
        for s_idx in sec["slide_indices"]:
            slide = prs.slides[s_idx]
            
            # Remove old placeholder numbers
    ...
    # 3. Insert 6 Section Divider slides backwards
    for sec in reversed(sections_def):
        d_slide = prs.slides.add_slide(prs.slide_layouts[1]) # SECTION_HEADER
    ...
    print(f"Total slides after section divider insertion: {len(prs.slides)}") # 37
    ...
    prs.save(v20_path)
    prs.save(v18_path)
    print("Saved presentations to v20 and v18 successfully.")
...
if __name__ == "__main__":
    ...
    print("37-SLIDE MASTER BUILD COMPLETED SUCCESSFULLY!")
