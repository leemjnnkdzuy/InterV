---
rule_id: "rule:industry:healthcare-pharmaceuticals"
kind: "industry"
...
schema_version: 2
---
# Rule ngành: Y tế & Dược phẩm

## Phạm vi

Áp dụng cho mọi level trong ngành **Y tế & Dược phẩm**. JD cụ thể được dùng để thu hẹp
...
1. **An toàn người bệnh**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
2. **Clinical reasoning trong phạm vi vai trò**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
3. **Evidence-based practice**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
4. **Giao tiếp và informed consent**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
5. **Quản lý thuốc/quy trình**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
6. **Quality improvement**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
7. **Đạo đức và bảo mật**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
8. **Interprofessional collaboration**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
...
1. Dữ kiện lâm sàng mơ hồ nhưng rủi ro có thể cao.
2. Phát hiện nguy cơ medication error.
3. Người bệnh từ chối kế hoạch được đề xuất.
4. Handoff thiếu thông tin quan trọng.
5. Quality indicator xấu đi qua nhiều kỳ.
