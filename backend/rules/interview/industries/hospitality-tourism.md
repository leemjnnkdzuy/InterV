---
rule_id: "rule:industry:hospitality-tourism"
kind: "industry"
...
schema_version: 2
---
# Rule ngành: Du lịch & Nhà hàng - Khách sạn

## Phạm vi

Áp dụng cho mọi level trong ngành **Du lịch & Nhà hàng - Khách sạn**. JD cụ thể được dùng để thu hẹp
...
1. **Guest service**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
2. **Service recovery**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
3. **Vận hành ca**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
4. **An toàn và vệ sinh**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
5. **Doanh thu và yield**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
6. **Phối hợp đa bộ phận**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
7. **Quản trị nhân sự tuyến đầu**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
8. **Trải nghiệm đa văn hóa**: phải được đo bằng hành vi, sản phẩm công việc hoặc quyết định có thể kiểm tra.
...
1. Overbooking hoặc hết phòng vào giờ cao điểm.
2. Khách phàn nàn công khai trong khi khu vực đông.
3. Thiếu nhân sự đột xuất trong ca.
4. Sự cố an toàn thực phẩm hoặc tài sản.
5. Mục tiêu doanh thu xung đột với chất lượng dịch vụ.
