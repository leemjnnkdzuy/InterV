---
rule_id: "rule:profile:healthcare-pharmaceuticals:chief-pharmacist-head-doctor"
kind: "profile"
industry: "Y tế & Dược phẩm"
level: "Chief Pharmacist/Head Doctor"
tier: 3
minimum_questions: 5
provenance_status: "design-blueprint-requires-validation"
schema_version: 2
---
# Profile phỏng vấn: Y tế & Dược phẩm / Chief Pharmacist/Head Doctor

## Phạm vi áp dụng

Blueprint mặc định cho **Y tế & Dược phẩm** ở level **Chief Pharmacist/Head Doctor**, ánh xạ
vào **Tier 3 - Senior**.
...
3. Mỗi câu phải trả về `grounding_ids` chứa `rule:profile:healthcare-pharmaceuticals:chief-pharmacist-head-doctor` và ít nhất một evidence ID hợp lệ khác.
...
| 2 | Situational | clinical reasoning trong phạm vi vai trò | Giả sử handoff thiếu thông tin quan trọng. Bạn sẽ xử lý theo thứ tự nào, dựa trên tiêu chí nào và khi nào cần escalation? | Kiểm tra guideline/protocol và lý do deviation nếu có. |
...
| 4 | Stakeholder + risk | quality improvement | Trong tình huống dữ kiện lâm sàng mơ hồ nhưng rủi ro có thể cao, bạn sẽ phối hợp các bên ra sao mà vẫn bảo vệ quality improvement và chuẩn nghề nghiệp? | Kiểm tra outcome hoặc quality indicator và điểm dừng rủi ro. |
| 5 | Reflection/level | interprofessional collaboration | Hãy mô tả một lần kết quả chưa đạt kỳ vọng trong phạm vi kết quả cấp nhóm/chương trình và chất lượng quyết định dài hạn. Bạn nhận ra điều gì, thay đổi cơ chế nào và bằng chứng nào cho thấy lần sau tốt hơn? | Yêu cầu phối hợp đa chuyên môn và handoff. |
...
| 2 | Có khái niệm nhưng thiếu vai trò, reasoning, kết quả hoặc chưa đạt phạm vi Chief Pharmacist/Head Doctor. |
...
| 5 | Vượt chuẩn Chief Pharmacist/Head Doctor: tạo cơ chế bền vững, dự báo rủi ro và nâng chất lượng cho người khác. |
