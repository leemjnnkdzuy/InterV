---
rule_id: "rule:profile:legal:legal-assistant"
kind: "profile"
industry: "Luật & Pháp lý"
level: "Legal Assistant"
tier: 1
minimum_questions: 5
provenance_status: "design-blueprint-requires-validation"
schema_version: 2
---
# Profile phỏng vấn: Luật & Pháp lý / Legal Assistant

## Phạm vi áp dụng

Blueprint mặc định cho **Luật & Pháp lý** ở level **Legal Assistant**, ánh xạ
...
3. Mỗi câu phải trả về `grounding_ids` chứa `rule:profile:legal:legal-assistant` và ít nhất một evidence ID hợp lệ khác.
...
| 2 | Situational | issue spotting | Giả sử điều khoản hợp đồng phân bổ rủi ro bất cân xứng. Bạn sẽ xử lý theo thứ tự nào, dựa trên tiêu chí nào và khi nào cần escalation? | Kiểm tra draft/memo/contract đã ẩn danh. |
...
| 4 | Stakeholder + risk | tư vấn rủi ro | Trong tình huống đối tác dùng áp lực deadline trong đàm phán, bạn sẽ phối hợp các bên ra sao mà vẫn bảo vệ tư vấn rủi ro và chuẩn nghề nghiệp? | Kiểm tra deadline, privilege và document control và điểm dừng rủi ro. |
| 5 | Reflection/level | đạo đức và bảo mật | Hãy mô tả một lần kết quả chưa đạt kỳ vọng trong phạm vi đầu ra cá nhân, chất lượng và độ tin cậy trong nhiệm vụ được giao. Bạn nhận ra điều gì, thay đổi cơ chế nào và bằng chứng nào cho thấy lần sau tốt hơn? | Yêu cầu kết quả đàm phán/tranh chấp cùng giới hạn vai trò. |
...
| 2 | Có khái niệm nhưng thiếu vai trò, reasoning, kết quả hoặc chưa đạt phạm vi Legal Assistant. |
...
| 5 | Vượt chuẩn Legal Assistant: tạo cơ chế bền vững, dự báo rủi ro và nâng chất lượng cho người khác. |
