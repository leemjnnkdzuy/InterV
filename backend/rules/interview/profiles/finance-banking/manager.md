---
rule_id: "rule:profile:finance-banking:manager"
kind: "profile"
...
schema_version: 2
---
# Profile phỏng vấn: Tài chính & Ngân hàng / Manager

## Phạm vi áp dụng

Blueprint mặc định cho **Tài chính & Ngân hàng** ở level **Manager**, ánh xạ
vào **Tier 3 - Senior**.
...
3. Mỗi câu phải trả về `grounding_ids` chứa `rule:profile:finance-banking:manager` và ít nhất một evidence ID hợp lệ khác.
...
| 2 | Situational | quản trị rủi ro | Giả sử lãi suất biến động làm thay đổi luận điểm đầu tư. Bạn sẽ xử lý theo thứ tự nào, dựa trên tiêu chí nào và khi nào cần escalation? | Kiểm tra sensitivity/scenario analysis và ngưỡng rủi ro. |
...
| 4 | Stakeholder + risk | độ chính xác dữ liệu | Trong tình huống mô hình dự báo lệch đáng kể so với actual, bạn sẽ phối hợp các bên ra sao mà vẫn bảo vệ độ chính xác dữ liệu và chuẩn nghề nghiệp? | Kiểm tra control, reconciliation và dấu vết phê duyệt và điểm dừng rủi ro. |
| 5 | Reflection/level | đạo đức nghề nghiệp | Hãy mô tả một lần kết quả chưa đạt kỳ vọng trong phạm vi kết quả cấp nhóm/chương trình và chất lượng quyết định dài hạn. Bạn nhận ra điều gì, thay đổi cơ chế nào và bằng chứng nào cho thấy lần sau tốt hơn? | Yêu cầu quyết định khi dữ liệu thiếu hoặc xung đột lợi ích. |
