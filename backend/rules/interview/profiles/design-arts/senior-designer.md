---
rule_id: "rule:profile:design-arts:senior-designer"
kind: "profile"
...
schema_version: 2
---
# Profile phỏng vấn: Thiết kế & Nghệ thuật / Senior Designer

## Phạm vi áp dụng

Blueprint mặc định cho **Thiết kế & Nghệ thuật** ở level **Senior Designer**, ánh xạ
...
3. Mỗi câu phải trả về `grounding_ids` chứa `rule:profile:design-arts:senior-designer` và ít nhất một evidence ID hợp lệ khác.
...
| 2 | Situational | research và insight | Giả sử design system bị các đội áp dụng không nhất quán. Bạn sẽ xử lý theo thứ tự nào, dựa trên tiêu chí nào và khi nào cần escalation? | Kiểm tra research evidence thay vì sở thích cá nhân. |
...
| 4 | Stakeholder + risk | kể chuyện thiết kế | Trong tình huống creative direction gây tranh luận về nhận diện thương hiệu, bạn sẽ phối hợp các bên ra sao mà vẫn bảo vệ kể chuyện thiết kế và chuẩn nghề nghiệp? | Kiểm tra usability, conversion, task success hoặc brand metric và điểm dừng rủi ro. |
| 5 | Reflection/level | đo tác động | Hãy mô tả một lần kết quả chưa đạt kỳ vọng trong phạm vi kết quả đo được của dự án, khách hàng hoặc quy trình. Bạn nhận ra điều gì, thay đổi cơ chế nào và bằng chứng nào cho thấy lần sau tốt hơn? | Yêu cầu trade-off giữa craft, accessibility và feasibility. |
...
| 2 | Có khái niệm nhưng thiếu vai trò, reasoning, kết quả hoặc chưa đạt phạm vi Senior Designer. |
...
| 5 | Vượt chuẩn Senior Designer: tạo cơ chế bền vững, dự báo rủi ro và nâng chất lượng cho người khác. |
