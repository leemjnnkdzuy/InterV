---
rule_id: "rule:profile:general:junior"
kind: "profile"
industry: "Khác"
level: "Junior"
tier: 1
...
schema_version: 2
---
# Profile phỏng vấn: Khác / Junior

## Phạm vi áp dụng

Blueprint mặc định cho **Khác** ở level **Junior**, ánh xạ
...
3. Mỗi câu phải trả về `grounding_ids` chứa `rule:profile:general:junior` và ít nhất một evidence ID hợp lệ khác.
...
| 2 | Situational | kiến thức/chuyên môn liên quan JD | Giả sử sửa một sai sót có ảnh hưởng tới người khác. Bạn sẽ xử lý theo thứ tự nào, dựa trên tiêu chí nào và khi nào cần escalation? | Kiểm tra hành động theo trình tự thay vì mô tả chung. |
...
| 4 | Stakeholder + risk | ownership | Trong tình huống bất đồng với stakeholder về cách làm, bạn sẽ phối hợp các bên ra sao mà vẫn bảo vệ ownership và chuẩn nghề nghiệp? | Kiểm tra trade-off và tiêu chí ra quyết định và điểm dừng rủi ro. |
| 5 | Reflection/level | đạo đức nghề nghiệp | Hãy mô tả một lần kết quả chưa đạt kỳ vọng trong phạm vi đầu ra cá nhân, chất lượng và độ tin cậy trong nhiệm vụ được giao. Bạn nhận ra điều gì, thay đổi cơ chế nào và bằng chứng nào cho thấy lần sau tốt hơn? | Yêu cầu bài học cùng thay đổi hành vi sau đó. |
