...
const steps: Step[] = [
  {
    ...
    colorClass: "rose",
    bgGradient: "from-rose-500/[0.05] to-purple-500/[0.05] dark:from-rose-500/5 dark:to-purple-500/5 border-rose-500/20 dark:border-rose-500/10",
    badgeColor: "bg-rose-500/15 border-rose-500/20 text-rose-500 dark:text-rose-400"
  },
  {
    num: "002",
    titleKey: "landing.howItWorks.step2Title",
    descriptionKey: "landing.howItWorks.step2Description",
    icon: <ChatSquareCode weight="BoldDuotone" className="w-7 h-7 text-amber-500 dark:text-amber-400" />,
    colorClass: "amber",
    bgGradient: "from-amber-500/[0.05] to-yellow-500/[0.05] dark:from-amber-500/5 dark:to-yellow-500/5 border-amber-500/20 dark:border-amber-500/10",
    badgeColor: "bg-amber-500/15 border-amber-500/20 text-amber-500 dark:text-amber-400"
  },
  {
    num: "003",
    titleKey: "landing.howItWorks.step3Title",
    descriptionKey: "landing.howItWorks.step3Description",
    icon: <Diploma weight="BoldDuotone" className="w-7 h-7 text-emerald-600 dark:text-emerald-400" />,
    colorClass: "emerald",
    bgGradient: "from-emerald-500/[0.05] to-teal-500/[0.05] dark:from-emerald-500/5 dark:to-teal-500/5 border-emerald-500/20 dark:border-emerald-500/10",
    badgeColor: "bg-emerald-500/15 border-emerald-500/20 text-emerald-600 dark:text-emerald-400"
  }
];
      ...
      <div className="w-full mx-auto flex flex-col gap-16"> 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center w-full">
          ...
          <div className="lg:col-span-7 flex flex-col gap-4 text-left">
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-black text-foreground tracking-tight uppercase leading-[1.05]">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end w-full">
            <div className="relative w-[280px] h-[360px] sm:w-[310px] sm:h-[400px] group/visual">
              ...
              <div className="absolute inset-0 rounded-[32px] overflow-hidden bg-card dark:bg-zinc-950 border border-border/80 dark:border-white/10 shadow-xl dark:shadow-[0_20px_40px_rgba(0,0,0,0.5)] flex items-center justify-center z-10">
                ...
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6 bg-gradient-to-t from-zinc-950/90 via-zinc-950/40 to-transparent z-20">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mt-4">
          {steps.map((step, idx) => (
            <motion.div
              ...
              className="relative rounded-3xl border border-border/80 dark:border-white/[0.06] hover:border-border dark:hover:border-white/12 transition-colors duration-250 bg-card/85 dark:bg-zinc-950/40 backdrop-blur-md p-5 flex flex-col gap-4 overflow-hidden group/card shadow-sm dark:shadow-[0_8px_32px_rgba(0,0,0,0.15)]"
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-xl font-black text-muted-foreground/70 tracking-wider">{step.num}</span>
              ...
              <div className={`bg-gradient-to-br rounded-2xl p-4 text-left border ${step.bgGradient}`}>
                <h4 className="font-extrabold text-foreground text-sm tracking-wide mb-2">
                  {t(step.titleKey)}
                </h4>
